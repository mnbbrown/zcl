...
func (v ZoneStatus) IsSupervisionReports() bool { return zcl.BitmapTest([]byte(v[:]), 4) }
func (v ZoneStatus) IsRestoreReports() bool     { return zcl.BitmapTest([]byte(v[:]), 5) }
func (v ZoneStatus) IsTrouble() bool            { return zcl.BitmapTest([]byte(v[:]), 6) }
func (v ZoneStatus) IsAc() bool                 { return zcl.BitmapTest([]byte(v[:]), 7) }
...
func (v *ZoneStatus) SetSupervisionReports(b bool) {
	copy((*v)[:], zcl.BitmapSet([]byte((*v)[:]), 4, b))
}
func (v *ZoneStatus) SetRestoreReports(b bool) { copy((*v)[:], zcl.BitmapSet([]byte((*v)[:]), 5, b)) }
func (v *ZoneStatus) SetTrouble(b bool)        { copy((*v)[:], zcl.BitmapSet([]byte((*v)[:]), 6, b)) }
func (v *ZoneStatus) SetAc(b bool)             { copy((*v)[:], zcl.BitmapSet([]byte((*v)[:]), 7, b)) }
...
func (ZoneStatus) MultiOptions() []zcl.Option {
	return []zcl.Option{
		...
		{Value: 4, Name: "Supervision Reports"},
		{Value: 5, Name: "Restore Reports"},
...
func (v ZoneType) IsVibrationSensor() bool         { return v == 0x002d }
...
func (v *ZoneType) SetVibrationSensor()            { *v = 0x002d }
...
func (ZoneType) SingleOptions() []zcl.Option {
	return []zcl.Option{
		...
		{Value: 0x002d, Name: "Vibration sensor"},
	}
}
